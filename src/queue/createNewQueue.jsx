import { Button, ModalCard, Header, FormItem, Select, FormLayout, Input } from "@vkontakte/vkui"
    ...
    <div style={{ position: 'absolute', backgroundColor: 'rgba(0, 0, 0, 0.5)', width: '100%', height: '100vh', top: 0, }}>
      <ModalCard actions={
        ...
        <FormLayout>
          ...
          <FormItem top="Дата">
            <Input placeholder="Введите дату (День/Месяц)" onChange={(e) => setPickedDate(e.target.value)} ></Input>
          </FormItem>
        </FormLayout>
      </ModalCard>
    </div>
